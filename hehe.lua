...
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/hluuvn/BloxFruit/refs/heads/main/MainShadow.lua"))()
...
Button.Image = "rbxassetid://79678427314607"
    ...
    function getHighestPoint()
        ...
        for _, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId=="rbxassetid://79678427314607" then
                    return v
                end
            end
        end
...
if currentTime - lastNotificationTime >= notificationCooldown then
    game.StarterGui:SetCore("SendNotification", {
        Title = "Shadow Hub",
        Text = "Tải Script thành công",
        Icon = "rbxthumb://type=Asset&id=79678427314607&w=150&h=150",
        Duration = 1
    })
